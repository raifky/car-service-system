        ...
        <div class="col-md-6">
            <form action="/tableaset">
                <div class="input-group mb-3">
                    <input type="text" class="form-control" placeholder="Search Menggunakan Nomor Handphone" name="search" value="{{ request('search') }}">
...
<div class="card mr-3 ml-3">
    <div class="card-header">
        ...
        <div class="">
            <a href="forminputaset"><button type="button" class="btn btn-primary plus float-right">Tambahkan
                    Data</button></a>
        </div>
    </div>
</div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="visible-print text-center">
                                                {!! QrCode::size(125)->generate(route('forminputservice', ['id' => $asets->id])) !!}
                                            </div>
                                        </td>
